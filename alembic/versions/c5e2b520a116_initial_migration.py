...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('description', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
        sa.Column('execution_params', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
        sa.Column('transformer_params', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
